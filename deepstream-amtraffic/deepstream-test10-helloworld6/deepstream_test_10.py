...
def recognize_license_plate(image,obj_meta,confidence):
    ...
    if (obj_meta.class_id == 1):        
        ...
        alpr_engine = Alpr("eu", "/etc/openalpr/openalpr_rai.conf", "/usr/share/openalpr/runtime_data")
        ...
        cv2.imwrite("/opt/nvidia/deepstream/deepstream-5.0/sources/python/apps/deepstream-test10-helloworld6/"+str(frame_number)+"_lpcut.jpg",lp_cutout)
        cv2.imwrite("/opt/nvidia/deepstream/deepstream-5.0/sources/python/apps/deepstream-test10-helloworld6/"+str(frame_number)+"_image.jpg",image)
